...
function ProgressSummary({percentage , completed}){
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex gap-4 sm:gap-6 justify-between items-end">
                            ...
                            <div className="text-right">
                                <p className="text-primary text-xl sm:text-2xl font-bold leading-none juzu-counter">{completed || 10}/30</p>
                    ...
                    <div className="relative">
                        <div className="rounded-full bg-gray-100 h-3 w-full overflow-hidden">
                            <div className="progress-fill h-full rounded-full bg-linear-to-r from-primary to-primary/80 progress-bar" style={{width: `${percentage || 10}%`}}></div>
                        </div>
